...
def get_config():
  ...
  training.num_train_steps = 60000
  ...
  model.dim = 10
  model.dim_mults = (1, 2, 3, 4, 5, 6) #qui potremmo mettere la quanvolution per aumentare le feature
  model.number_quantum_channel= 1
  model.model = 'QuanvUNet' # 'QVUNet' or 'FullQVUNet' or 'QuanvUNet' or 'UNet'
