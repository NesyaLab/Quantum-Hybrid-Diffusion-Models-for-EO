...
Denoising U-Net:
A Quanvolutional Conditioned U-Net serves as the backbone for estimating the noise to be removed. This model is a11
hybrid quantum-classical architecture which applies operations to feature extraction stages via a novel quanvolutional approach within a conditioned diffusion framework.
